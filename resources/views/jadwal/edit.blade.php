...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="col-md-12">
                {!! Form::open(['route' => ['jadwal.update', $jadwal->id], 'method' => 'put']) !!}
                @csrf
                <div class="form-group">
                    {!! Form::label('kelas', 'Nama Kelas', ['class' => 'form-label']) !!}
                    {!! Form::text('kelas', $jadwal->nama_kelas, [
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('materi', $dataMateri, $jadwal->materi_id, [
                        'class' => 'form-control',
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::date('tanggal_mulai', $jadwal->tanggal_mulai, [
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::date('tanggal_selesai', $jadwal->tanggal_selesai, [
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::time('jam_mulai', $jadwal->jam_mulai, [
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::time('jam_selesai', $jadwal->jam_selesai, [
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('instruktur', $dataInstruktur, $jadwal->instruktur, [
                        'class' => 'form-control',
                ...
                <div class="form-group">
                    ...
                    @foreach ($hariOptions as $key => $label)
                        <div class="form-check form-check-inline">
                            {!! Form::checkbox('hari[]', $key, in_array($key, old('hari', [])), ['class' => 'form-check-input']) !!}
